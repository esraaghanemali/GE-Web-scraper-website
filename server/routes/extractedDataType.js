...
const middleware = require('../middlewares/extractedDataType');
 ...
 *   }
 */
// router.get('/:extractedDataTypeId', middleware.ge)
/**
 ...
 */
    .post('/', middleware.createExtractedDataType)
    /**
     * @api {post} /users signup with email & password
     * @apiName UserSignup
     * @apiGroup Users
 ...
 * }
     ...
     * @apiUse EmailExistsError
     */
    .post('/update/', middleware.updateExtractedDataType)
