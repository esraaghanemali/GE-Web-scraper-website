...
const middleware = require('../middlewares/user-package');
const router = express.Router();


router.post('/', middleware.createPackage)
 ...
 *   }
 */
router.get('/', middleware.getAllPackages)
 ...
 *   }
 */
router.get('/:packageId', middleware.getPackageById)
/**
 ...
 */
    ...
    // .post('/:packageName/maxPagesNumber/maxItemsPerPageNumber', middleware.createPackage)
    /**
     * @api {post} /users signup with email & password
     * @apiName UserSignup
     * @apiGroup Users
 ...
 * }
     ...
     * @apiUse EmailExistsError
     */
    router.put('/:packageId/packageName/maxPagesNumber/maxItemsPerPageNumber', middleware.updatePackage)
